...
const compromissos = [
	...
	new Compromisso(Cerv, 'Show', 'Sem Barreiras', '13/04', 'A definir', 'Cabo Frio'),
	new Compromisso(Jardins, 'Show', 'Tropic Thunder', '18/04', 'A definir', 'Rio das Ostras'),
	...
	new Compromisso(Groot, 'Show', 'Rato de Ouro', '31/07', 'A definir', 'Rio das Ostras'),
